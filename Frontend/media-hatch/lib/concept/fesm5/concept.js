...
import { Component, Directive, Input, NgModule, Injectable, defineInjectable, InjectionToken, Inject, inject } from '@angular/core';
import { __extends, __decorate, __metadata, __values } from 'tslib';
 ...
 */
/** @type {?} */
var MULTI_LOGGER_SERVICES = new InjectionToken('multi-logger logger services');
/**
