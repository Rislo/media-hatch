...
export class DdlValleyLinksScraper {
  ...
  public async scrape(scrapedMediaInfo: HtmlScrapedMediaInfo): Promise<LinksPackage[]> {
    const htmlDocument = await HtmlMediaScraper.getHtmlDocument(scrapedMediaInfo.pageUrl);
